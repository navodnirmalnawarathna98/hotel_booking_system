...
const AddRoom = () => {
    ...
    const handleSaveChanges = async () => {
        ...
        // Basic validation
        if (!roomNumber || !roomType || !price || !acType || !smallDesc || !longDesc || !bedCount || !guestCount) {
                    ...
                    <Form>
                        ...
                        <Form.Group controlId="formImages">
                            ...
                            <Form.Control
                                ...
                                className="form-control-style w-100 mt-2"
                            />
                            {images.length > 0 && <p className="mt-2">{images.length} images ready to upload</p>}
                        </Form.Group>
                        <Form.Group controlId="formAmenities">
                            <Form.Label className="mt-2">Amenities (comma separated)</Form.Label>
                            <Form.Control
                                type="text"
